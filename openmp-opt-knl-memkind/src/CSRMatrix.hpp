...
CSRMatrix {
  ...
  std::vector<LocalOrdinal, FastMemAllocator<LocalOrdinal>> row_offsets;
  std::vector<LocalOrdinal>  row_offsets_external;
  std::vector<GlobalOrdinal, FastMemAllocator<GlobalOrdinal>> packed_cols;
  std::vector<Scalar, FastMemAllocator<Scalar>>        packed_coefs;
