       ...
       Parameters& params, YAML_Doc& ydoc)
{
  ...
  RUN_TIMED_FUNCTION("imposing Dirichlet BC...",
            impose_dirichlet(0.0, A, b, global_nx+1, global_ny+1, global_nz+1, mesh.v_bc_rows_0), dirbc_time, t_total);
  RUN_TIMED_FUNCTION("imposing Dirichlet BC...",
            impose_dirichlet(1.0, A, b, global_nx+1, global_ny+1, global_nz+1, mesh.v_bc_rows_1), dirbc_time, t_total);
#ifdef MINIFE_DEBUG
